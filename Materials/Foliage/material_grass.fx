...
// Subsurface translucency for sunlit grass blades
...
const float3 customB = float3(0.4, 0.7, 0.1);
const float2 customBMapLoopNum = 1.0;

// =============================================================================
// PROCEDURAL VERTEX WIND ANIMATION: GRASS & GROUND VEGETATION
// =============================================================================
#define WIND_ENABLE 1
#define WIND_TYPE 1 // 1: Grass / Ground Plants (Base anchored, quadratic tip bend)

const float  windSpeed = 1.6;                       // Meadow breeze gust speed
const float  windStrength = 0.30;                   // Bending strength at tips
const float  windFrequency = 0.60;                  // Grass rolling wave frequency
const float3 windDirection = float3(1.0, 0.0, 0.5); // Ground-parallel breeze direction
const float  windTurbulence = 0.45;                 // Micro blade jitter
