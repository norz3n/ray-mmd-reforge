// Toon (cel-shaded) duplicate of: Foliage/material_palm.fx
...
// Glossy tropical palm frond wax
...
// =============================================================================
// PROCEDURAL VERTEX WIND ANIMATION: PALM & BROAD TROPICAL FRONDS
// =============================================================================
#define WIND_ENABLE 1
#define WIND_TYPE 3 // 3: Palm & Broad Fronds (Undulating stem flex + edge flapping)

const float  windSpeed = 1.2;                       // Wave speed
const float  windStrength = 0.25;                   // Bending reach
const float  windFrequency = 0.30;                  // Wave length
const float3 windDirection = float3(1.0, 0.2, 0.4); // Coastal breeze vector
const float  windTurbulence = 0.40;                 // Frond edge flap amplitude
