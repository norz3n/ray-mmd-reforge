// Toon (cel-shaded) duplicate of: Foliage/material_vines.fx
...
// =============================================================================
// PROCEDURAL VERTEX WIND ANIMATION: HANGING VINES & IVY
// =============================================================================
#define WIND_ENABLE 1
#define WIND_TYPE 2 // 2: Hanging Vines & Ivy (Top-anchored pendulum swing)

const float  windSpeed = 1.1;                       // Pendulum cycle speed
const float  windStrength = 0.22;                   // Hanging swing amplitude
const float  windFrequency = 0.35;                  // Spatial phase offset
const float3 windDirection = float3(1.0, 0.1, 0.4); // Wind vector
const float  windTurbulence = 0.30;                 // Tendril flutter
