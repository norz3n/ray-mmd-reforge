// Toon (cel-shaded) duplicate of: Eye/material_eye.fx
...
// High smoothness for deep glossy eye reflections
...
// Smoothness of the outer corneal lens layer (0.95 = glass-like crisp highlight)
...
const float3 customB = float3(0.45, 0.42, 0.55);
