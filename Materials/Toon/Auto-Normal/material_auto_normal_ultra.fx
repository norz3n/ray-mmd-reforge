// Toon (cel-shaded) duplicate of: Auto-Normal/material_auto_normal_ultra.fx
...
#define NORMAL_MAP_FROM 3 // Auto-Normal from Diffuse
#define NORMAL_MAP_TYPE 5 // Ultra Quality (Sobel)
