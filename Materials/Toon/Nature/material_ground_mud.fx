// Toon (cel-shaded) duplicate of: Nature/material_ground_mud.fx
// Wet muddy terrain with puddle reflections and Hex-Tiling
...
const float3 albedo = float3(0.20, 0.15, 0.11);
