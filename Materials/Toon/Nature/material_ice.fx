// Toon (cel-shaded) duplicate of: Nature/material_ice.fx
// Glacial translucent ice with glass refraction and interior absorption
...
const float3 albedo = float3(0.85, 0.92, 0.98);
...
const float3 customB = float3(0.65, 0.85, 0.98);
