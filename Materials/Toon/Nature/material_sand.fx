// Toon (cel-shaded) duplicate of: Nature/material_sand.fx
// Desert / beach quartz sand with Micro-Glitter silica crystal sparkle and Hex-Tiling
...
const float3 albedo = float3(0.82, 0.68, 0.45);
