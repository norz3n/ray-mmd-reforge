// Toon (cel-shaded) duplicate of: Nature/material_snow.fx
// Fresh powder snow with Subsurface transmission, Micro-Glitter sparkle, and Hex-Tiling
...
const float3 albedo = float3(0.96, 0.97, 0.99);
...
const float3 customB = float3(0.70, 0.85, 1.00);
