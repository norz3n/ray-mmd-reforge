...
const float3 specular = 0.02; // Water IOR 1.333 Fresnel base reflectivity
...
const float customB = 0.1;
const float2 customBMapLoopNum = 1.0;

// Physically based wet surface & puddle model (Sebastien Lagarde / Naughty Dog)
...
const float2 wetnessMapLoopNum = 2.0;
const float2 wetnessMapOffsetNum = 0.0;

#define WETNESS_POROSITY_MAP_FROM 0
