// Toon (cel-shaded) duplicate of: Cloth/material_lace.fx
// Fine white lace with stochastic Hashed Alpha testing
...
const float3 albedo = float3(0.95, 0.95, 0.95);
