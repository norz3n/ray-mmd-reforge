// Toon (cel-shaded) duplicate of: Cloth/material_silk.fx
...
const float3 albedo = float3(0.9, 0.88, 0.85);
...
const float normalMapScale = 0.25;
const float normalMapLoopNum = 12.0;
...
const float3 customB = float3(0.62, 0.62, 0.72);
