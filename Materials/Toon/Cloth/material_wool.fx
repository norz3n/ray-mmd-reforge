// Toon (cel-shaded) duplicate of: Cloth/material_wool.fx
// Soft knit wool with high microfacet wrap and velvet forward scatter
...
const float3 albedo = float3(0.85, 0.82, 0.78);
...
const float3 customB = float3(0.95, 0.95, 0.95);
