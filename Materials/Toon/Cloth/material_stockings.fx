// Toon (cel-shaded) duplicate of: Cloth/material_stockings.fx
// Translucent black nylon stockings / pantyhose with Hashed Alpha and rim sheen
...
const float3 albedo = float3(0.08, 0.06, 0.06);
...
const float3 customB = float3(0.35, 0.25, 0.25);
