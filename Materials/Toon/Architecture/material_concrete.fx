// Toon (cel-shaded) duplicate of: Architecture/material_concrete.fx
// Architectural raw reinforced concrete with Hex-Tiling
...
const float3 albedo = float3(0.55, 0.55, 0.53);
