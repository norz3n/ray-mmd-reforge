// Toon (cel-shaded) duplicate of: Architecture/material_brick.fx
// PBR Kiln Brick wall with Mikkelsen Hex-Tiling to eliminate tiling repetition on large surfaces
...
const float3 albedo = float3(0.72, 0.32, 0.22);
