// Toon (cel-shaded) duplicate of: Architecture/material_wet_asphalt.fx
// Wet road asphalt with clearcoat water film and puddle specular sheen
...
const float3 albedo = float3(0.09, 0.09, 0.09);
