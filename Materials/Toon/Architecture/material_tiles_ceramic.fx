// Toon (cel-shaded) duplicate of: Architecture/material_tiles_ceramic.fx
// Glazed ceramic wall and floor tiles with ClearCoat finish
...
const float3 albedo = float3(0.92, 0.92, 0.94);
