// Toon (cel-shaded) duplicate of: Architecture/material_wood_rough.fx
// Unpolished rustic wooden planks with Hex-Tiling
...
const float3 albedo = float3(0.48, 0.34, 0.22);
