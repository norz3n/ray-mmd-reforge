// Toon (cel-shaded) duplicate of: Architecture/material_marble_polished.fx
// Carrara white polished marble with Subsurface scattering and ClearCoat
...
const float3 albedo = float3(0.95, 0.95, 0.94);
...
const float3 customB = float3(0.95, 0.90, 0.85);
