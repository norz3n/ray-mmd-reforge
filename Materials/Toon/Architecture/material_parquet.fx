// Toon (cel-shaded) duplicate of: Architecture/material_parquet.fx
// Polished hardwood parquet flooring with polyurethane ClearCoat reflection
...
const float3 albedo = float3(0.58, 0.36, 0.18);
