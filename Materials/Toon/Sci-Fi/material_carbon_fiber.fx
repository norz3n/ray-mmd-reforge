// Toon (cel-shaded) duplicate of: Sci-Fi/material_carbon_fiber.fx
// Woven composite carbon fiber with dual-layer anisotropic specular sheen
...
const float3 albedo = float3(0.06, 0.06, 0.06);
