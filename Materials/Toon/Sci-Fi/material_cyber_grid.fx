// Toon (cel-shaded) duplicate of: Sci-Fi/material_cyber_grid.fx
// Matte dark substrate with high-intensity glowing neon cyan circuitry
...
const float3 albedo = float3(0.04, 0.04, 0.04);
...
const float3 emissive = float3(0.0, 1.0, 0.8);
const float3 emissiveBlink = 1.0;
const float  emissiveIntensity = 3.5;
