// Toon (cel-shaded) duplicate of: Sci-Fi/material_hologram.fx
// Futuristic cyan holographic display with pulsing emission and Hashed Alpha
...
const float3 albedo = float3(0.0, 0.85, 1.0);
...
const float3 emissive = float3(0.1, 0.9, 1.0);
