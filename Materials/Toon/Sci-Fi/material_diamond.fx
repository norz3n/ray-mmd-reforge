// Toon (cel-shaded) duplicate of: Sci-Fi/material_diamond.fx
// Faceted refractive gemstone / diamond with optical dispersion
...
const float3 albedo = float3(0.98, 0.98, 1.0);
...
const float3 customB = float3(0.98, 0.99, 1.0);
