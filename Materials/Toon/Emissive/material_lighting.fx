// Toon (cel-shaded) duplicate of: Emissive/material_lighting.fx
...
#define EMISSIVE_MAP_APPLY_MORPH_COLOR 1
#define EMISSIVE_MAP_APPLY_MORPH_INTENSITY 1
#define EMISSIVE_MAP_APPLY_BLINK 2
